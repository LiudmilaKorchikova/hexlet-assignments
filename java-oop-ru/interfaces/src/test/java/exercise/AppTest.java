...
class AppTest {
    ...
    void testReversedSequenceToString() {
        ReversedSequence original = new ReversedSequence("abcdef");
        String expected = "fedcba";
        assertThat(original.toString()).isEqualTo(expected);
    }
    ...
    void testReversedSequenceLength() {
        ReversedSequence original = new ReversedSequence("abcdef");
        int expected = 6;
        assertThat(original.length()).isEqualTo(expected);
    }
    ...
    void testReversedSequenceCharAt() {
        ReversedSequence original = new ReversedSequence("abcdef");
        char expected = 'b';
        assertThat(original.charAt(4)).isEqualTo(expected);
    }
    ...
    void testReversedSequenceSubSequence() {
        ReversedSequence original = new ReversedSequence("abcdef");
        String expected = "fed";
        assertThat(original.subSequence(0, 3).toString()).isEqualTo(expected);
    }
    // END
}
